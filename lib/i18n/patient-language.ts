...
const translations: Record<PatientLanguage, Record<TranslationKey, string>> = {
  en: {
    ...
    doctor: 'Doctor', facility: 'Facility', notAssigned: 'Not assigned', searchAppointments: 'Search your appointments...', allStatuses: 'All statuses', loadingAppointments: 'Loading appointments...', noAppointments: 'No appointments yet', bookFirstAppointment: 'Book your first appointment using the button above.', bookAnAppointment: 'Book an Appointment',
  ...
  mr: {
    ...
    doctor: 'डॉक्टर', facility: 'आरोग्य केंद्र', notAssigned: 'निवडलेले नाही', searchAppointments: 'तुमच्या भेटी शोधा...', allStatuses: 'सर्व स्थिती', loadingAppointments: 'भेटी लोड होत आहेत...', noAppointments: 'अद्याप कोणतीही भेट नाही', bookFirstAppointment: 'वरचे बटण वापरून तुमची पहिली भेट बुक करा.', bookAnAppointment: 'भेट बुक करा',
  ...
  hi: {
    ...
    doctor: 'डॉक्टर', facility: 'स्वास्थ्य केंद्र', notAssigned: 'चयनित नहीं', searchAppointments: 'अपनी अपॉइंटमेंट खोजें...', allStatuses: 'सभी स्थिति', loadingAppointments: 'अपॉइंटमेंट लोड हो रही हैं...', noAppointments: 'अभी कोई अपॉइंटमेंट नहीं', bookFirstAppointment: 'ऊपर दिए बटन से अपनी पहली अपॉइंटमेंट बुक करें।', bookAnAppointment: 'अपॉइंटमेंट बुक करें',
