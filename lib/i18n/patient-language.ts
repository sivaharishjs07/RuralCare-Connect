...
export type TranslationKey =
  ...
  | 'bookAndView'
  | 'bookAppointment'
  | 'appointmentSavedOffline'
  | 'offlineAppointmentSynced'
  | 'time'
  | 'symptoms'
  | 'analyzeSymptoms'
  | 'riskLevel'
...
const translations: Record<PatientLanguage, Record<TranslationKey, string>> = {
  en: {
    appointmentSavedOffline: 'Saved offline. It will sync automatically when internet connection is restored.',
    offlineAppointmentSynced: 'Offline appointment synced successfully.',
  ...
  mr: {
    appointmentSavedOffline: 'ऑफलाइन जतन केले. इंटरनेट कनेक्शन परत आल्यावर ते आपोआप समक्रमित होईल.',
    offlineAppointmentSynced: 'ऑफलाइन भेट यशस्वीपणे समक्रमित झाली.',
  ...
  hi: {
    appointmentSavedOffline: 'ऑफलाइन सेव हो गई। इंटरनेट कनेक्शन वापस आने पर यह अपने आप सिंक हो जाएगी।',
    offlineAppointmentSynced: 'ऑफलाइन अपॉइंटमेंट सफलतापूर्वक सिंक हो गई।',
