...
export default function NotificationsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
      ...
      <div className="mb-4"><h2 className="text-lg font-semibold text-foreground">Your notifications</h2><p className="text-sm text-muted-foreground">{loading ? 'Loading notifications...' : `${filteredNotifications.length} notification${filteredNotifications.length === 1 ? '' : 's'} shown`}</p></div>
